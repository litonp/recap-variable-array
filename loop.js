/*
LOOP
1. Display "Akje amar mon valo nei" for 39 items?
...
7. Creat an array for all the mobile phones . Display all the elements of the
by using a while loop ?
8. Run a loop from 30 to 86. this loop will stop if the values get higher than
